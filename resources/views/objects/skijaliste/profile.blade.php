...
<head>
  ...
  <!-- Basic Page Needs
  ================================================== -->
  <title>SveZaSport.ba | Royal Ski Arena</title>
  <meta charset="utf-8">
...
<!-- Header
        ...
        <div class="player-info">
          ...
          <div class="player-info__item player-info__item--photo">
            <figure class="player-info__photo">
              <img class="frontend-profilna-slika-a1" src="assets/images/objekti/lrg-bjelasnica2.jpg" alt="">
            </figure>
          </div>
          <!-- Player Photo / End -->
          ...
          <div class="player-info__item player-info__item--details">
            ...
            <div class="player-info__title player-info__title--desktop">
              <h1 class="player-info__name">
                <span class="player-info__first-name">Skijaški kompleks</span>
                <span class="player-info__last-name">Bjelašnica</span>
              </h1>
            </div>
  ...
  <div class="site-content">
          ...
          <div class="content col-md-4 overscreen">
            ...
            <!-- Widget: Osnovne info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__num">Početak sezone</td>
                            <td class="lineup__name">01. Decembar, 2018.</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="assets/images/icons/nadmorska.svg" alt="">
                            </td>
                            <td class="lineup__num">Nadmorska visina</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">2067 m</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="assets/images/icons/river-trail.svg" alt="">
                            </td>
                            <td class="lineup__num">Ukupno staza</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">8</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="assets/images/icons/ski-lift.svg" alt="">
                            </td>
                            <td class="lineup__num">Ukupno liftova</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">8</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__num">Kapacitet korisnika</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">10600</a></td>
                          </tr>
      ...
      <!-- Widget: Kontakt info -->
                <aside class="widget card card--has-table widget--sidebar widget-lineup-table">
                  <div class="widget__title card__header">
                    <h4><i class="fa fa-info-circle"></i> Osobine skijališta</h4>
                  </div>
                  <div class="widget__content card__content">
              ...
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="assets/images/icons/bed.svg" alt="">
                            </td>
                            <td class="lineup__num">Hoteli i prenoćišta</td>
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__num">Coffee barovi</td>
                            <td class="lineup__name">Da</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__num">Restorani</td>
                            <td class="lineup__name">Da</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="assets/images/icons/ski-glasses.svg" alt="">
                            </td>
                            <td class="lineup__num">Najam opreme</td>
                            <td class="lineup__name">Da</td>
                          </tr>
       ...
       <!-- Single Product Tabbed Content -->
        <div class="product-tabs card card--xlg">
          ...
          <ul class="nav nav-tabs nav-justified nav-product-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#tab-vremeplov" role="tab" data-toggle="tab"><i class="fa fa-history"></i><small>Vremeplov</small>Skijališta</a></li>
       <li role="presentation"><a href="#tab-staze-liftovi" role="tab" data-toggle="tab"><i class="fa fa-road"></i><small>Staze i</small>Liftovi</a></li>
      ...
      <!-- Tab: Općenito -->
            <div role="tabpanel" class="tab-pane fade in active" id="tab-opcenito">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">Babin do</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">Trnovo</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">Sarajevski kanton</td>
                          </tr>
            ...
            <!-- Modal content / End -->
              ...
              <div class="card__content">
                ...
                <div class="game-result">
                          ...
                          <div class="col-xs-12 col-md-8">
                            <div class="game-result__table-stats game-result__table-stats--soccer">
                              <table class="table table-wrap-bordered table-thead-color tabela-szs-standardi">
                                ...
                                <tbody>
                                  <tr>
                                    <td class="ocjena-szs-info">Služba za održavanje</td>
                                    <td class="ocjena-szs-ans">Da</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Hitna interventna jedinica</td>
                                    <td class="ocjena-szs-ans">Da</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Škola skijanja</td>
                                    <td class="ocjena-szs-ans">Da</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Škola snowboardinga</td>
                                    <td class="ocjena-szs-ans">Da</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Prodavnice skijaške opreme</td>
                                    <td class="ocjena-szs-ans">Da</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Mobilna spasilačka ekipa</td>
                                    <td class="ocjena-szs-ans">Da</td>
                                  </tr>
                                  <tr>
                  ...
                  <tr>
                                    <td class="ocjena-szs-info">Noćno skijanje</td>
                                    <td class="ocjena-szs-ans">Da</td>
                                  </tr>
                  <tr>
                  ...
                  <tr>
                                    <td class="ocjena-szs-info"></td>
                                    <td class="ocjena-szs-ans"></td>
                                  </tr>
              ...
              <table class="table table-wrap-bordered table-thead-color">
                    ...
                    <span class="ocjena-info-alt"> Max. ocjena: 10 | Ukupno ocjena: 143</span>
                         ...
                         <div class="col-xs-12 col-md-12">
                  <div class="row">
                  <div class="col-md-9 col-xs-6 specs-ocjena"><img  src="assets/images/icons/coins-money-stack.svg" class="flow-icons-012 info-objekt-ikona"></img>  Cjenovnik usluga</div>
                ...
                <div class="row">
                  <div class="col-md-9 col-xs-6 specs-ocjena"><img  src="assets/images/icons/river-trail.svg" class="flow-icons-012 info-objekt-ikona"></img>  Uslovi skijališta</div>
      ...
      <div class="widget__title card__header istaknute-licnosti-naslov">
         ...
         <div class="card__content">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">Spust</span></h1>
                            <span class="alc-staff__header-role">Teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                        <div class="alc-staff-inner">
                          ...
                          <dl class="alc-staff-details">
                            ...
                            <dd class="alc-staff-details__value">1340 m</dd>

                            <dt class="alc-staff-details__label">Trajanje spusta</dt>
                            <dd class="alc-staff-details__value">16 min</dd>

                            <dt class="alc-staff-details__label">Tačka polazišta</dt>
                            <dd class="alc-staff-details__value">1650 m</dd>

                            <dt class="alc-staff-details__label">Tačka izlaza</dt>
                            <dd class="alc-staff-details__value">1200 m</dd>
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">Kotlovi</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                        <div class="alc-staff-inner">
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">Slalom/Veleslalom</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">Kolijevka</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">4</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">5</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">5A</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">5B</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Staza <span class="alc-staff__header-last-name">Noćno skijanje</span></h1>
                            <span class="alc-staff__header-role">Srednje teška</span>
                          </header>
                        </div>
                      <div class="col-md-6">
      ...
      <div class="col-md-12">
      <div class="widget__title card__header istaknute-licnosti-naslov">
                <h4><i class="fa fa-sitemap"></i> Ski liftovi</h4>
              </div>
         ...
         <div class="card__content">
                ...
                <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">Babin Do</span></h1>
                            <span class="alc-staff__header-role">Trosjed</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                        <div class="alc-staff-inner">
                ...
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            <dd class="alc-staff-details__value">1350/h</dd>
              
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">1340 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">12 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">1640 m</dd>
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">Štinji Do</span></h1>
                            <span class="alc-staff__header-role">Dvosjed</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                        <div class="alc-staff-inner">
                          ...
                          <dl class="alc-staff-details">
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            <dd class="alc-staff-details__value">1200/h</dd>
              
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">1172 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">6 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">1754 m</dd>
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">BY Šumski skok</span></h1>
                            <span class="alc-staff__header-role">Ski Lift</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                        <div class="alc-staff-inner">
                          ...
                          <dl class="alc-staff-details">
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            <dd class="alc-staff-details__value">900/h</dd>
              
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">840 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">4 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">1706 m</dd>
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">BX Babin do</span></h1>
                            <span class="alc-staff__header-role">Ski Lift</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                ...
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            ...
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">612 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">3 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">1440 m</dd>
        ...
        <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">Heliodrom</span></h1>
                            <span class="alc-staff__header-role">Ski lift</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                ...
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            ...
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">725 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">3,5 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">1864 m</dd>
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">Kotlovi</span></h1>
                            <span class="alc-staff__header-role">Ski lift</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                ...
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            ...
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">665 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">3 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">2067 m</dd>
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">Kolijevka</span></h1>
                            <span class="alc-staff__header-role">Ski lift</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                ...
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            ...
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">886 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">4 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">1436 m</dd>
            ...
            <div class="row">
                      <div class="col-md-6">
                          <header class="alc-staff__header">
                            <h1 class="alc-staff__header-name">Lift <span class="alc-staff__header-last-name">Baby x3</span></h1>
                            <span class="alc-staff__header-role">Ski lift</span>
                          </header>
                        </div>
                      <div class="col-md-6">
                        <div class="alc-staff-inner">
                          ...
                          <dl class="alc-staff-details">
                <dt class="alc-staff-details__label">Kapacitet korisnika</dt>
                            <dd class="alc-staff-details__value">300/h</dd>
              
                            <dt class="alc-staff-details__label">Dužina vožnje</dt>
                            <dd class="alc-staff-details__value">150 m</dd>

                            <dt class="alc-staff-details__label">Trajanje vožnje</dt>
                            <dd class="alc-staff-details__value">1 min</dd>

                            <dt class="alc-staff-details__label">Krajnja tačka</dt>
                            <dd class="alc-staff-details__value">1 m</dd>
                        ...
                        <td class="team-schedule__versus">
                          <div class="team-meta">
                           <div class="team-meta__info">
                            <div class="team-meta__info">
                              <h6 class="team-meta__name">Pojedinačna karta </h6>
                            </div>
                          </div>
              </div>
                        </td>
                        <td class="team-schedule__time">5,00 KM</td>
             ...
             <tr>
                        <td class="team-schedule__versus">
                          <div class="team-meta">
                           <div class="team-meta__info">
                            <div class="team-meta__info">
                              <h6 class="team-meta__name">Dvosatna dnevna karta</h6>
                            </div>
                          </div>
              </div>
                        </td>
                        <td class="team-schedule__time">12,00 KM</td>
            <td class="team-schedule__time">6,00 KM</td>
                      </tr>
            <tr>
                        <td class="team-schedule__versus">
                          <div class="team-meta">
                           <div class="team-meta__info">
                            <div class="team-meta__info">
                              <h6 class="team-meta__name">Trosatna dnevna karta</h6>
                            </div>
                          </div>
              </div>
                        </td>
                        <td class="team-schedule__time">15,00 KM</td>
            <td class="team-schedule__time">8,00 KM</td>
                      </tr>
            <tr>
                        <td class="team-schedule__versus">
                          <div class="team-meta">
