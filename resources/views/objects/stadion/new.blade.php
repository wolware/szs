...
<!-- Header
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Stadion</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    ================================================== -->
      ...
      <div class="row">
        <form id="createNewDvorana" role="form" action="{{ url('/objects/stadion/create') }}" method="POST" enctype="multipart/form-data" >
        {!! csrf_field() !!}        
    ...
    <div class="row form-segment">
      ...
      <div class="row"> 
          ...
          <div class="form-group col-md-4">
                    <label for="tereni"><img class="flow-icons-013" src="{{asset('assets/images/icons/field.svg')}}"></img> Vrsta travnjaka</label>
                    <input type="text" name="vrsta_travnjaka" id="tereni" min="1" class="form-control" placeholder="Unesite broj terena">
                  </div>
          
          <div class="form-group col-md-4">
                    <label for="kapacitet"><img class="flow-icons-013" src="{{asset('assets/images/icons/gledaoci.svg')}}"></img> Dužina terena(m)</label>
                    <input type="number" name="duzina_terena" id="kapacitet" min="1" class="form-control" placeholder="Unesite kapacitet objekta">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="kapacitet"><img class="flow-icons-013" src="{{asset('assets/images/icons/gledaoci.svg')}}"></img> Širina terena(m)</label>
                    <input type="number" name="sirina_terena" id="kapacitet" min="1" class="form-control" placeholder="Unesite kapacitet objekta">
                  </div>
          <div class="form-group col-md-4">
                    <label for="kapacitet"><img class="flow-icons-013" src="{{asset('assets/images/icons/gledaoci.svg')}}"></img> Kapacitet gledaoca</label>
      ...
      <div class="row form-objavi-klub-01">
       ...
       <div class="row">
          ...
          <div class="form-group col-md-4">
                    <label for="svlacionice"><img class="flow-icons-013" src="{{asset('assets/images/icons/room-key.svg')}}"></img> Broj svlacionica</label>
       ...
       <div class="row">
          <div class="form-group col-md-3">
            <label for="tusevi">Tuševi sa toplom vodom u svlač.</label>
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Rekviziti za rekreaciju i treninge</label>
            <select class="form-control" id="tabla" name="rekviziti">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="igraona">Komentatorske kabine</label>
            <select class="form-control" id="igraona" name="kabine">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="ormarici">Razglas</label>
            <select class="form-control" id="ormaric" name="razglas">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="klimatizacija">Fan shop</label>
            <select class="form-control" id="klimatizacija" name="fan_shop">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="klimatizacija">Zaštitne ograde</label>
            <select class="form-control" id="klimatizacija" name="zastitne_ograde">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
