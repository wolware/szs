...
@section('content')
      ...
      <div class="container">
        ...
        <div class="player-info__title player-info__title--mobile">
          <h1 class="player-info__name">
            <span class="player-info__first-name">Kuglana</span>
            <span class="player-info__last-name">{{$kuglana->naziv}}</span>
          </h1>
        </div>
  ...
  <div class="site-content">
          ...
          <div class="content col-md-4 overscreen">
            ...
            <!-- Widget: Osnovne info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__num">Broj staza</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$kuglana->broj_staza}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('assets/images/icons/parquet.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Broj kugli</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$kuglana->broj_kugli}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$kuglana->povrsina_objekta}}m<sup>2</sup></a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$kuglana->kapacitet_objekta}}</a></td>
                          </tr>
      ...
      <div class="col-md-6 profili-soc-mreza">
              <a href="{{$kuglana->fb}}" class="btn-social-counter btn-social-counter--fb" target="_blank">
                <div class="btn-social-counter__icon">
       ...
       <div class="col-md-6 profili-soc-mreza">
        <a href="{{$kuglana->instagram}}" class="btn-social-counter btn-social-counter--instagram" target="_blank">
                <div class="btn-social-counter__icon">
       ...
       <div class="col-md-6 profili-soc-mreza">
        <a href="{{$kuglana->yt}}" class="btn-social-counter btn-social-counter--yt" target="_blank">
                <div class="btn-social-counter__icon">
      ...
      <!-- Widget: Kontakt info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$kuglana->wifi}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$kuglana->parking}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$kuglana->restoran}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$kuglana->kafeterija}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$kuglana->pristup_invalid}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('assets/images/icons/room-key.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Ukupno ormarića</td>
                            <td class="lineup__name">{{$kuglana->broj_ormarica}}</td>
                          </tr>
      ...
      <!-- Widget: SZS info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$kuglana->id}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
      ...
      <!-- Tab: Općenito -->
            <div role="tabpanel" class="tab-pane fade in active" id="tab-opcenito">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$kuglana->grad}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$kuglana->opcina}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$kuglana->kanton}}</td>
                          </tr>
      ...
      <div class="col-md-6">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$kuglana->entitet}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border"><img class="zastava-drzave" src="{{asset('assets/images/icons/bosnia-and-herzegovina.svg')}}" alt=""> {{$kuglana->drzava}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$kuglana->kontinent}}</td>
                          </tr>
                          ...
                          <div class="col-xs-12 col-md-8">
                            <div class="game-result__table-stats game-result__table-stats--soccer">
                              <table class="table table-wrap-bordered table-thead-color tabela-szs-standardi">
                                ...
                                <tbody>
                                  <tr>
                                    <td class="ocjena-szs-info">Rezervacije (telefon/online)</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->rezervacija}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Ekran za rezultate</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->tabla}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Pomagala za djecu</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->pomagala}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Ormarić za garderobu sa ključem</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->ormaric}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Mokri čvor za posjetioce</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->mokri_cvor}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Specijalna obuća (oprema)</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->obuca}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Klimatizacija</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->klimatizacija}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Higijenska oprema (čarape)</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->oprema}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Članska karta</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->clanska_kartica}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Video nadzor</td>
                                    <td class="ocjena-szs-ans">{{$kuglana->video_nadzor}}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
