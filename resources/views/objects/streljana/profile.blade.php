...
@section('content')
      ...
      <div class="container">
        ...
        <div class="player-info__title player-info__title--mobile">
          <h1 class="player-info__name">
            <span class="player-info__first-name">Streljana</span>
            <span class="player-info__last-name">{{$streljana->naziv}}</span>
          </h1>
        </div>
  ...
  <div class="site-content">
          ...
          <div class="content col-md-4 overscreen">
            ...
            <!-- Widget: Osnovne info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$streljana->broj_terena}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$streljana->vrsta_podloge}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$streljana->povrsina_objekta}}m<sup>2</sup></a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$streljana->kapacitet_objekta}}</a></td>
                          </tr>
      ...
      <div class="col-md-6 profili-soc-mreza">
              <a href="{{$streljana->fb}}" class="btn-social-counter btn-social-counter--fb" target="_blank">
                <div class="btn-social-counter__icon">
       ...
       <div class="col-md-6 profili-soc-mreza">
        <a href="{{$streljana->instagram}}" class="btn-social-counter btn-social-counter--instagram" target="_blank">
                <div class="btn-social-counter__icon">
       ...
       <div class="col-md-6 profili-soc-mreza">
        <a href="{{$streljana->yt}}" class="btn-social-counter btn-social-counter--yt" target="_blank">
                <div class="btn-social-counter__icon">
      ...
      <!-- Widget: Kontakt info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$streljana->wifi}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$streljana->parking}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$streljana->restoran}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$streljana->kafeterija}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$streljana->pristup_invalid}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$streljana->broj_svlacionica}}</td>
                          </tr>
      ...
      <!-- Widget: SZS info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$streljana->id}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
      ...
      <!-- Tab: Općenito -->
            <div role="tabpanel" class="tab-pane fade in active" id="tab-opcenito">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$streljana->grad}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$streljana->opcina}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$streljana->kanton}}</td>
                          </tr>
      ...
      <div class="col-md-6">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$streljana->entitet}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border"><img class="zastava-drzave" src="{{asset('assets/images/icons/bosnia-and-herzegovina.svg')}}" alt=""> {{$streljana->drzava}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$streljana->kontinent}}</td>
                          </tr>
                              ...
                              <table class="table table-wrap-bordered table-thead-color tabela-szs-standardi">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="ocjena-szs-ans">{{$streljana->tusevi}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Tabla za rezultate</td>
                                    <td class="ocjena-szs-ans">{{$streljana->tabla}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Igraona u sklopu objekta</td>
                                    <td class="ocjena-szs-ans">{{$streljana->igraona}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Ormarić za garderobu sa ključem</td>
                                    <td class="ocjena-szs-ans">{{$streljana->ormaric}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Mokri čvor za posjetioce</td>
                                    <td class="ocjena-szs-ans">{{$streljana->mokri_cvor}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Rekviziti za rekreaciju</td>
                                    <td class="ocjena-szs-ans">{{$streljana->rekviziti}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Klimatizacija</td>
                                    <td class="ocjena-szs-ans">{{$streljana->klimatizacija}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Zaštitne mreže</td>
                                    <td class="ocjena-szs-ans">{{$streljana->zastitne_mreze}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Optimalna temperatura</td>
                                    <td class="ocjena-szs-ans">{{$streljana->optimalna_temperatura}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Video nadzor</td>
                                    <td class="ocjena-szs-ans">{{$streljana->video_nadzor}}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
