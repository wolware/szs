...
<!-- Header
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Streljana</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    ================================================== -->
      ...
      <div class="row">
        <form id="createNewDvorana" role="form" action="{{ url('/objects/streljana/create') }}" method="POST" enctype="multipart/form-data" >
        {!! csrf_field() !!}        
    ...
    <div class="row form-segment">
      ...
      <div class="row"> 
          ...
          <div class="form-group col-md-4">
                    <label for="tereni"><img class="flow-icons-013" src="{{asset('assets/images/icons/field.svg')}}"></img> Broj strelista</label>
                    <input type="number" name="broj_strelista" id="tereni" min="1" class="form-control" placeholder="Unesite broj terena">
                  </div>
      ...
      <div class="row form-objavi-klub-01">
       ...
       <div class="row">
          <div class="form-group col-md-3">
            <label for="tusevi">Najam opreme</label>
            <select class="form-control" id="tusevi" name="najam_opreme">
              <option value="" disabled>Odaberite</option>
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Unos vlastite opreme</label>
            <select class="form-control" id="tabla" name="vlastita_oprema">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Servis opreme</label>
            <select class="form-control" id="tabla" name="servis_opreme">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="igraona">Skola streljastva</label>
            <select class="form-control" id="igraona" name="skola">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="klimatizacija">Zaštitna oprema</label>
            <select class="form-control" id="klimatizacija" name="zastitna_oprema">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
