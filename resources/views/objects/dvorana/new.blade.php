...
<!-- Header
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Dvorana</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    ================================================== -->
      ...
      <div class="row">
        <form id="createNewDvorana" role="form" action="{{ url('/objects/dvorana/create') }}" method="POST" enctype="multipart/form-data" >
        {!! csrf_field() !!}        
    ...
    <div class="row form-segment">
      ...
      <div class="row"> 
          ...
          <div class="form-group col-md-4">
                    <label for="tereni"><img class="flow-icons-013" src="{{asset('assets/images/icons/field.svg')}}"></img> Broj terena (sala)</label>
                    <input type="number" name="broj_terena" id="tereni" min="1" class="form-control" placeholder="Unesite broj terena">
                  </div>
          
          <div class="form-group col-md-4">
                    <label for="podloga"><img class="flow-icons-013" src="{{asset('assets/images/icons/parquet.svg')}}"></img> Vrsta podloge</label>
            <select class="form-control" id="podloga" name="vrsta_podloge">
              <option value="" disabled >Izaberite podlogu sale</option>
          ...
          <div class="form-group col-md-4">
                    <label for="povrsina"><img class="flow-icons-013" src="{{asset('assets/images/icons/scale-screen.svg')}}"></img> Površina objekta (m<superscript>2</superscript>)</label>
                    <input type="number" name="povrsina_objekta" id="povrsina" min="1" class="form-control" placeholder="Unesite ukupnu površinu objekta">
                  </div>
          
          <div class="form-group col-md-4">
                    <label for="kapacitet"><img class="flow-icons-013" src="{{asset('assets/images/icons/gledaoci.svg')}}"></img> Kapacitet objekta</label>
      ...
      <div class="row form-objavi-klub-01">
       ...
       <div class="row">
          ...
          <div class="form-group col-md-4">
                    <label for="svlacionice"><img class="flow-icons-013" src="{{asset('assets/images/icons/room-key.svg')}}"></img> Broj svlačionica</label>
                    <input type="number" name="broj_svlacionica" id="svlacionice" class="form-control" placeholder="Unesite broj svlačionica">
                  </div>
       ...
       <div class="row">
          <div class="form-group col-md-3">
            <label for="tusevi">Tuševi sa toplom vodom</label>
            <select class="form-control" id="tusevi" name="tusevi">
              <option value="" disabled>Odaberite</option>
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Tabla za rezultate</label>
          ...
          <div class="form-group col-md-3">
            <label for="igraona">Igraona u sklopu objekta</label>
            <select class="form-control" id="igraona" name="igraona">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="ormarici">Ormarić za garderobu sa ključem</label>
            <select class="form-control" id="ormaric" name="ormaric">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="rekviziti">Rekviziti za rekreaciju</label>
            <select class="form-control" id="rekviziti" name="rekviziti">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="mreze">Zaštitne mreže</label>
            <select class="form-control" id="mreze" name="zastitne_mreze">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="temperatura">Optimalna temperatura</label>
            <select class="form-control" id="temperatura" name="optimalna_temperatura">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
