...
<!-- Header
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Teretana</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    ================================================== -->
      ...
      <div class="row">
        <form id="createNewDvorana" role="form" action="{{ url('/objects/teretana/create') }}" method="POST" enctype="multipart/form-data" >
        {!! csrf_field() !!}        
    ...
    <div class="row form-segment">
      ...
      <div class="row"> 
          ...
          <div class="form-group col-md-4">
                    <label for="tereni"><img class="flow-icons-013" src="{{asset('assets/images/icons/field.svg')}}"></img> Broj sprava (sala)</label>
                    <input type="number" name="broj_sprava" id="tereni" min="1" class="form-control" placeholder="Unesite broj terena">
                  </div>
      ...
      <div class="row form-objavi-klub-01">
       ...
       <div class="row">
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Rekviziti za fitness</label>
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Besplatno korištenje rukavica</label>
            <select class="form-control" id="tabla" name="rukavice">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="igraona">Dostupni treneri</label>
            <select class="form-control" id="igraona" name="dostupni_treneri">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="temperatura">Clanska kartica</label>
            <select class="form-control" id="temperatura" name="clanska_kartica">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
