...
@section('content')
      ...
      <div class="container">
        ...
        <div class="player-info__title player-info__title--mobile">
          <h1 class="player-info__name">
            <span class="player-info__first-name">Teretana</span>
            <span class="player-info__last-name">{{$teretana->naziv}}</span>
          </h1>
        </div>
  ...
  <div class="site-content">
          ...
          <div class="content col-md-4 overscreen">
            ...
            <!-- Widget: Osnovne info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__num">Broj sprava</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$teretana->broj_sprava}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$teretana->vrsta_podloge}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$teretana->povrsina_objekta}}m<sup>2</sup></a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$teretana->kapacitet_objekta}}</a></td>
                          </tr>
      ...
      <div class="col-md-6 profili-soc-mreza">
              <a href="{{$teretana->fb}}" class="btn-social-counter btn-social-counter--fb" target="_blank">
                <div class="btn-social-counter__icon">
       ...
       <div class="col-md-6 profili-soc-mreza">
        <a href="{{$teretana->instagram}}" class="btn-social-counter btn-social-counter--instagram" target="_blank">
                <div class="btn-social-counter__icon">
       ...
       <div class="col-md-6 profili-soc-mreza">
        <a href="{{$teretana->yt}}" class="btn-social-counter btn-social-counter--yt" target="_blank">
                <div class="btn-social-counter__icon">
      ...
      <!-- Widget: Kontakt info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$teretana->wifi}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$teretana->parking}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$teretana->restoran}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$teretana->kafeterija}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$teretana->pristup_invalid}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$teretana->broj_svlacionica}}</td>
                          </tr>
      ...
      <!-- Widget: SZS info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$teretana->id}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
      ...
      <!-- Tab: Općenito -->
            <div role="tabpanel" class="tab-pane fade in active" id="tab-opcenito">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$teretana->grad}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$teretana->opcina}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$teretana->kanton}}</td>
                          </tr>
      ...
      <div class="col-md-6">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$teretana->entitet}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border"><img class="zastava-drzave" src="{{asset('assets/images/icons/bosnia-and-herzegovina.svg')}}" alt=""> {{$teretana->drzava}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$teretana->kontinent}}</td>
                          </tr>
                              ...
                              <table class="table table-wrap-bordered table-thead-color tabela-szs-standardi">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="ocjena-szs-ans">{{$teretana->tusevi}}</td>
                                  </tr> <tr>
                                    <td class="ocjena-szs-info">Rekviziti za fitness</td>
                                    <td class="ocjena-szs-ans">{{$teretana->rekviziti}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Besplatno korištenje rukavica</td>
                                    <td class="ocjena-szs-ans">{{$teretana->rukavice}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Dostupni treneri</td>
                                    <td class="ocjena-szs-ans">{{$teretana->treneri}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Ormarić za garderobu sa ključem</td>
                                    <td class="ocjena-szs-ans">{{$teretana->ormaric}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Mokri čvor za posjetioce</td>
                                    <td class="ocjena-szs-ans">{{$teretana->mokri_cvor}}</td>
                                  </tr>
                 
                  <tr>
                                    <td class="ocjena-szs-info">Klimatizacija</td>
                                    <td class="ocjena-szs-ans">{{$teretana->klimatizacija}}</td>
                                  </tr>

                  <tr>
                                    <td class="ocjena-szs-info">Članska karta</td>
                                    <td class="ocjena-szs-ans">{{$teretana->clanska_kartica}}</td>
                                  </tr>
                  <tr>
                                    <td class="ocjena-szs-info">Video nadzor</td>
                                    <td class="ocjena-szs-ans">{{$teretana->video_nadzor}}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
