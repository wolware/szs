...
<!-- Header
        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Bazen</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    ================================================== -->
      ...
      <div class="row">
        <form id="createNewDvorana" role="form" action="{{ url('/objects/bazen/create') }}" method="POST" enctype="multipart/form-data" >
        {!! csrf_field() !!}        
    ...
    <div class="row form-segment">
      ...
      <div class="row"> 
          ...
          <div class="form-group col-md-4">
                    <label for="tereni"><img class="flow-icons-013" src="{{asset('assets/images/icons/field.svg')}}"></img> Broj brazena</label>
                    <input type="text" name="broj_bazena" id="tereni" min="1" class="form-control" placeholder="Unesite broj staza">
                  </div>
          
          <div class="form-group col-md-4">
                    <label for="kapacitet"><img class="flow-icons-013" src="{{asset('assets/images/icons/gledaoci.svg')}}"></img> Vodeni efekti</label>
                    <input type="number" name="vodeni_efekti" id="kapacitet" min="1" class="form-control" placeholder="Unesite broj kugli">
                  </div>
                  <div class="form-group col-md-4">
                    <label for="kapacitet"><img class="flow-icons-013" src="{{asset('assets/images/icons/gledaoci.svg')}}"></img> Vodena površina(m2)</label>
                    <input type="number" name="vodena_povrsina" id="kapacitet" min="1" class="form-control" placeholder="Unesite povrsinu objekta">
                  </div>
          <div class="form-group col-md-4">
                    <label for="kapacitet"><img class="flow-icons-013" src="{{asset('assets/images/icons/gledaoci.svg')}}"></img> Kapacitet kupača</label>
      ...
      <div class="row form-objavi-klub-01">
       ...
       <div class="row">
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Najam opreme</label>
            <select class="form-control" id="tabla" name="najam_opreme">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="tabla">Bazeni za djecu</label>
            <select class="form-control" id="tabla" name="bazeni">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="ormarici">Unos rekvizita</label>
            <select class="form-control" id="ormaric" name="rakviziti">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
          ...
          <div class="form-group col-md-3">
            <label for="klimatizacija">Detektor urina</label>
            <select class="form-control" id="klimatizacija" name="detektor">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
           ...
           <div class="form-group col-md-3">
            <label for="video">Optimalna temperatura</label>
            <select class="form-control" id="video" name="optimalna_temperatura">
              <option value="" disabled>Odaberite</option>
              <option value="Da">Da</option>
              <option value="Ne">Ne</option>
            </select>
