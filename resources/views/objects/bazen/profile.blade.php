      ...
      <div class="container">
        ...
        <div class="player-info__title player-info__title--mobile">
          <h1 class="player-info__name">
            <span class="player-info__first-name">Bazen</span>
            <span class="player-info__last-name">{{$bazen->naziv}}</span>
          </h1>
        </div>
        ...
        <div class="row profil-content-b06">
          ...
          <div class="content col-md-4 overscreen">
                      ...
                      <table class="table lineup-table">
                        <tbody>
						  ...
						  <tr>
                            ...
                            <td class="lineup__num">Broj bazena (sala)</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$bazen->broj_terena}}</a></td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('assets/images/icons/parquet.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Vodeni efekti</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$bazen->vodeni_efekti}}</a></td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('assets/images/icons/scale-screen.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Vodena površina</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$bazen->vodena_povrsina}}m<sup>2</sup></a></td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('assets/images/icons/gledaoci.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Kapacitet kupača</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$bazen->kapacitet_objekta}}</a></td>
                          </tr>
			...
			<div class="col-md-6 profili-soc-mreza">
              <a href="{{$bazen->fb}}" class="btn-social-counter btn-social-counter--fb" target="_blank">
                <div class="btn-social-counter__icon">
			 ...
			 <div class="col-md-6 profili-soc-mreza">
			  <a href="{{$bazen->instagram}}" class="btn-social-counter btn-social-counter--instagram" target="_blank">
                <div class="btn-social-counter__icon">
			 ...
			 <div class="col-md-6 profili-soc-mreza">
			  <a href="{{$bazen->yt}}" class="btn-social-counter btn-social-counter--yt" target="_blank">
                <div class="btn-social-counter__icon">
                      ...
                      <table class="table lineup-table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="lineup__name">{{$bazen->wifi}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$bazen->parking}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$bazen->restoran}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$bazen->kafeterija}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$bazen->pristup_invalid}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('assets/images/icons/room-key.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Ukupno ormarica</td>
                            <td class="lineup__name">{{$bazen->broj_ormarica}}</td>
                          </tr>
                      ...
                      <table class="table lineup-table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="lineup__name">{{$bazen->id}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info">
                      ...
                      <table class="table lineup-table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="lineup__name gadget-no-border">{{$bazen->grad}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$bazen->opcina}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$bazen->kanton}}</td>
                          </tr>
                      ...
                      <table class="table lineup-table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="lineup__name gadget-no-border">{{$bazen->entitet}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border"><img class="zastava-drzave" src="{{asset('assets/images/icons/bosnia-and-herzegovina.svg')}}" alt=""> {{$bazen->drzava}}</td>
                          </tr>
						  <tr>
							<td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border">{{$bazen->kontinent}}</td>
                          </tr>
                              ...
                              <table class="table table-wrap-bordered table-thead-color tabela-szs-standardi">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td class="ocjena-szs-ans">{{$bazen->tusevi}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Tabla za rezultate</td>
                                    <td class="ocjena-szs-ans">{{$bazen->tabla}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Najam opreme</td>
                                    <td class="ocjena-szs-ans">{{$bazen->najam_opreme}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Ormarić za garderobu sa ključem</td>
                                    <td class="ocjena-szs-ans">{{$bazen->ormaric}}</td>
                                  </tr>
                                  <tr>
                                    <td class="ocjena-szs-info">Mokri čvor za posjetioce</td>
                                    <td class="ocjena-szs-ans">{{$bazen->mokri_cvor}}</td>
                                  </tr>
								  <tr>
                                    <td class="ocjena-szs-info">Bazeni za djecu</td>
                                    <td class="ocjena-szs-ans">{{$bazen->bazeni}}</td>
                                  </tr>
								  <tr>
                                    <td class="ocjena-szs-info">Klimatizacija</td>
                                    <td class="ocjena-szs-ans">{{$bazen->klimatizacija}}</td>
                                  </tr>
								  <tr>
                                    <td class="ocjena-szs-info">Unos rekvizita</td>
                                    <td class="ocjena-szs-ans">{{$bazen->rekviziti}}</td>
                                  </tr>
								  <tr>
                                    <td class="ocjena-szs-info">Optimalna temperatura</td>
                                    <td class="ocjena-szs-ans">{{$bazen->optimalna_temperatura}}</td>
                                  </tr>
								  <tr>
                                    <td class="ocjena-szs-info">Detektor urina</td>
                                    <td class="ocjena-szs-ans">{{$bazen->detektor}}</td>
                                  </tr>
								  <tr>
                                    <td class="ocjena-szs-info">Video nadzor</td>
                                    <td class="ocjena-szs-ans">{{$bazen->video_nadzor}}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
