      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/sprint (1).svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Atletika</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    ================================================== -->
        ...
        <div class="row identitet-style">
         ...
         <div class="col-md-6">
          ...
          <div class="form-group col-md-12">
            ...
            <select class="form-control" id="asss" name="karakter" required>
      ...
      <div class="row form-objavi-klub-01">
       ...
       <div class="row">
          ...
          <div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Primarni ekstremitet</label>
            <select class="form-control" id="ski-disciplina" name="ekstremitet">
              <option value="" selected>Izaberite ekstremitet</option>
          ...
          <div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Disciplina</label>
            <select class="form-control" id="ski-disciplina" name="disciplina">
              <option value="" selected>Izaberite atletsku disciplinu</option>
              <option value="Trcanje">Trcanje</option>
              <option value="Bocanje">Bocanje</option>
              <option value="Skakanje">Skakanje</option>
              <option value="Višeboj">Višeboj</option>
            </select>
          </div>

          <div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Disciplina trčanja</label>
            <select class="form-control" id="ski-disciplina" name="disciplina_trcanja">
          ...
          <div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Disciplina bacanja</label>
            <select class="form-control" id="ski-disciplina" name="disciplina_bacanja">
              <option value="" selected>Disciplina bacanja</option>
              <option value="Koplje">Koplje</option>
              <option value="Disk">Disk</option>
              <option value="Kugla">Kugla</option>
              <option value="Kladivo">Kladivo</option>
            </select>
          </div>

           <div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Disciplina skakanja</label>
            <select class="form-control" id="ski-disciplina" name="disciplina_skakanja">
              <option value="" selected>Disciplina skakanja</option>
              <option value="Skok u dalj">Skok u dalj</option>
              <option value="Skok s motkom">Skok s motkom</option>
              <option value="Troskok">Troskok</option>
            </select>
          </div>

          <div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Disciplina višeboja</label>
          ...
          <div class="form-group col-md-4">
            <label for="agent"><img class="flow-icons-013" src="{{asset('assets/images/icons/agent.sv')}}g"></img> Trener</label>
            <input type="text" name="trener" id="agent" class="form-control" placeholder="Unesite ime trenera">
          </div>
