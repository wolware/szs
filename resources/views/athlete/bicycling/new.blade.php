      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/bicycle.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Bisiklista</li>
            </ol>
          </div>
        </div>
      </div>
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
						...
						<select class="form-control" id="ski-disciplina" name="kategorija">
							...
							<option value="Durmski biciklizam">Durmski biciklizam</option>
							<option value="Brdski biciklizam">Brdski biciklizam</option>
