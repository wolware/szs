      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('images/icons/basketball.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Košarkaš/Košarkašica</li>
            </ol>
          </div>
        </div>
      </div>
       ...
       <!-- Single Product Tabbed Content -->
        <div class="product-tabs card card--xlg">
          ...
          <ul class="nav nav-tabs nav-justified nav-product-tabs" role="tablist">
           ...
           <form id="createNewFootballer" role="form" action="{{ url('/athlete/basketball/create') }}" method="POST" enctype="multipart/form-data" >
				{!! csrf_field() !!}	
          <!-- Tab panes -->
          <div class="tab-content card__content">
				 ...
				 <div class="col-md-6">
				  ...
				  <div class="form-group col-md-12">
                    <label for="karakter-kluba"><img class="flow-icons-013" src="{{asset('images/icons/edit.svg')}}"></img> Karakter sportiste</label>
						<select class="form-control" id="asas" name="karakter" required>
			...
			<div class="row"> 
				  <div class="form-group col-md-4">
        			...
        			<input class="form-control" id="date" name="dob" placeholder="Izaberite datum rođenja" type="text" required/>
      			  </div>
				  
				  <div class="form-group col-md-4">
                    <label for="klub"><img class="flow-icons-013" src="{{asset('images/icons/klubovi-icon.svg')}}"></img> Klub</label>
                    <input type="text" name="klub" id="klub" class="form-control" placeholder="Unesite ime kluba za koji sportista nastupa" required>
                  </div>
				  
				  <div class="form-group col-md-4">
                    <label for="takmicenje"><img class="flow-icons-013" src="{{asset('images/icons/trophy.svg')}}"></img> Takmičenje</label>
                    <input type="text" name="takmicenje" id="takmicenje" class="form-control" placeholder="Unesite naziv takmičenja" required>
                  </div>
			...
			<div class="row form-objavi-klub-01">
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
						<label for="visina"><img class="flow-icons-013" src="{{asset('images/icons/height.svg')}}"></img> Visina</label>
						<input type="number" name="visina" id="visina" class="form-control" placeholder="Unesite visinu u cm" required>
					</div>
					
					<div class="form-group col-md-4">
						<label for="tezina"><img class="flow-icons-013" src="{{asset('images/icons/weight.svg')}}"></img> Težina</label>
						<input type="number" name="tezina" id="tezina" class="form-control" placeholder="Unesite težinu u kg" required>
					</div>
					
					<div class="form-group col-md-4">
						<label for="primarno"><img class="flow-icons-013" src="{{asset('images/icons/runer-silhouette-running-fast.svg')}}"></img> Primarni ekstremitet</label>
					...
					<div class="form-group col-md-4">
						<label for="pozicija"><img class="flow-icons-013" src="{{asset('images/icons/street-view.svg')}}"></img> Pozicija</label>
						<input type="text" name="pozicija" id="pozicija" class="form-control" placeholder="Primarna pozicija">
					</div>
					
					<div class="form-group col-md-4">
						<label for="agent"><img class="flow-icons-013" src="{{asset('images/icons/agent.svg')}}"></img> Agent</label>
