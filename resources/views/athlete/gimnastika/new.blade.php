      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/man-at-bar.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Gimnastika</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="tab-content card__content">
			...
			<div class="row form-objavi-klub-01">
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
						<label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Grana Gimnastike</label>
						<select class="form-control" id="ski-disciplina" name="grana">
							<option value="" selected>Izaberite granu gimnastike</option>
							<option value="Ritmicka gimnastika">Ritmička gimnastika</option>
							<option value="Sportska gimnastika">Sportska gimnastika</option>
						</select>
					</div>
