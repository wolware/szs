                        ...
                        <div class="product-tabs card card--xlg">
                            ...
                            <ul class="nav nav-tabs nav-justified nav-product-tabs" role="tablist">
                                ...
                                <li role="presentation" class="preslic"><a href="#tab-predispozicije" role="tab"
                                        ...
                                        Sportiste</a></li>
                                <li role="presentation"><a href="#tab-biografija" role="tab" data-toggle="tab"><i
                            ...
                            <form id="createNewFootballer" role="form" action="{{ url('/athlete/footballer/create') }}"
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="tab-opcenito">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-6 objavi-klub-logo-setup">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div class="alc-staff__photo">
                                                            <img class="slika-upload-klub" id="slika_upload_klub"
                                                                 src="{{asset('images/dino-secic.jpg')}}" alt="">
                                                        </div>
                                                    ...
                                                    <div class="col-md-5 sadrzaj-slike">
                                                        ...
                                                        <label class="btn btn-default btn-xs btn-file dodaj-sliku-button">
                                                            Odaberi sliku... <input type="file" id="slikaprof"
                                                                                    name="avatar" style="display: none;"
                                                                                    required accept="image/*"
                                                                                    onchange="previewFile('slikaprof','slika_upload_klub')">
                                                        </label>
                                                        <div class="info001">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="ime-kluba"><img class="flow-icons-013"
                                                            ...
                                                            Ime sportiste</label>
                                                        <input type="text" name="ime" id="ime-sportiste"
                                                               class="form-control" placeholder="Unesite ime sportiste"
                                                               required>
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="ime-kluba"><img class="flow-icons-013"
                                                                                    src="{{asset('images/icons/edit.svg')}}">
                                                            Prezime sportiste</label>
                                                        <input type="text" name="prezime" id="ime-kluba"
                                                               class="form-control"
                                                               placeholder="Unesite prezime sportiste" required>
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label for="karakter-kluba"><img class="flow-icons-013"
                                                                                         src="{{asset('images/icons/edit.svg')}}">
                                                            Karakter sportiste</label>
                                                        <select class="form-control" id="karakter-kluba" name="karakter"
                                                                required>
                                                            <option value="profesionalac" selected>Profesionalni
                                                                sportista
                                                            </option>
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="kontinent"><img class="flow-icons-013"
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="drzava"><img class="flow-icons-013"
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="entitet"><img class="flow-icons-013"
                                                                          src="{{asset('images/icons/map.svg')}}">
                                                    Entitet/Distrikt</label>
                                                <select class="form-control" id="entitet" name="entitet" required>
                                                    <option value="" disabled selected>Izaberite entitet/distrikt
                                                    </option>
                                            ...
                                            <div class="form-group col-md-4" id="kantonDiv">
                                                <label for="kanton"><img class="flow-icons-013"
                                                ...
                                                <select class="form-control" id="kanton" name="kanton">
                                                    ...
                                                    <option value="hnk" disabled>Hercegovačko-neretvanski Kanton
                                                    </option>
                                            ...
                                            <div class="form-group col-md-4" id="opcineDiv">
                                                <label for="opcine-ks"><img class="flow-icons-013"
                                                                            src="{{asset('images/icons/opcina.svg')}}">
                                                    Općine Kantona Sarajevo</label>
                                            ...
                                            <div class="form-group col-md-4" id="regijaDiv" style="display: none;">
                                                <label for="regija"><img class="flow-icons-013"
                                                                         src="{{asset('images/icons/placeholder.svg')}}">
                                                    Regija</label>
                                            ...
                                            <div class="form-group col-md-4" id="opSrb" style="display: none;">
                                                <label for="opcine-sz-reg"><img class="flow-icons-013"
                                                                                src="{{asset('images/icons/opcina.svg')}}">
                                                    Općine Sarajevsko-Zvorničke regije</label>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" name="grad" id="mjesto" onFocus="initAutocomplete()"
                                                       class="form-control" placeholder="Unesite mjesto kluba" required>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="fb" id="fcb" class="form-control"
					...
					-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group form-group--submit col-md-6">
                                                <a type="submit" name="submit"
                                                   class="btn btn-default btn-sm btn-block btn-dalje prvi_korak_end">Sljedeći
                                                    korak <i class="fa fa-chevron-right"></i></a>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group form-group--submit col-md-6">
                                                <a href="#tab-biografija" role="tab" data-toggle="tab"
                                                   class="btn btn-default btn-sm btn-block btn-dalje">Sljedeći korak <i
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea class="form-control" rows="20" id="opis"
                                                                  name="content" maxlength="1050"
                                                                  placeholder="Upišite ukratko informacije vezane za historijat vašeg kluba i njegovu tradiciju..."></textarea>
                                                    </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane fade neaktivno" id="tab-vitrina">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group col-md-6">
                                                    <label for="vrsta-nagrade"><img class="flow-icons-013"
                                                                                    src="{{asset('images/icons/medalja.svg')}}">
                                                        Vrsta nagrade</label>
                                                    <select class="form-control" id="vrsta-nagrade"
                                                            name="vrsta_nagrade[]">
                                                        <option value="" disabled selected>Izaberite vrstu osvojene
                                                            nagrade
                                                        </option>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select class="form-control" id="tip-nagrade" name="tip_nagrade[]">
                                                        <option value="" disabled selected>Izaberite tip nagrade
                                                        </option>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select class="form-control" id="tip-nagrade"
                                                            name="nivo_takmicenja[]">
                                                        <option value="" disabled selected>Izaberite nivo takmičenja
                                                        </option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="naziv_takmicenja[]" id="takmicenje"
                                                           class="form-control"
                                                ...
                                                <div class="form-group col-md-6 col-xs-12">
                                                    <label for="sezona"><img class="flow-icons-013"
                                                                             src="{{asset('images/icons/small-calendar.svg')}}">
                                                        Sezona/Godina</label>
                                                    <input type="text" name="trofej_sezona[]" id="sezona"
                                                           class="form-control"
                                                ...
                                                <div class="form-group col-md-6 col-xs-12">
                                                    ...
                                                    <input type="number" name="trofej_osvajanja[]" id="osvajanja"
                                                           class="form-control"
                                    ...
                                    <div role="tabpanel" class="tab-pane fade neaktivno" id="tab-galerija">
                                        ...
                                        <div class="row dodavanje-slika">
                                            <div class="col-md-12 sadrzaj-slike">
                                                ...
                                                <label class="btn btn-default btn-xs btn-file dodaj-sliku-button">
                                                    Odaberi slike... <input type="file" class="galerijak"
                                                                            name="galerija[]"
                                        ...
                                        <div class="row form-objavi-klub-01">
                                            <div class="album__item col-xs-6 col-sm-3">
                                                ...
                                                <div class="progress-stats upload-slike-statust-bar">
                                                    <div class="progress">
                                                        <div class="progress__bar progress__bar-width-100"
                                            ...
                                            <div class="form-group form-group--submit col-md-6">
                                                <button type="submit"
                                                        class="btn btn-default btn-sm btn-block btn-dalje"><i
                                                            class="fa fa-plus-circle"></i> Završi i objavi</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="bravo-info">Predložak koji ste napravili će biti u najkraćem
                                                mogućem vremenskom periodu pregledan od strane naše administracije, te
                                                ukoliko bude zadovoljavao sve uvjete koje nalaže Sve Za Sport, biti će i
                                                objavljen.</p>
