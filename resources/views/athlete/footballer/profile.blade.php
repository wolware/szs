        ...
        <div class="player-info">
          ...
          <div class="player-info__item player-info__item--photo">
            <figure class="player-info__photo">
              <img class="frontend-profilna-slika-a1" src="{{asset('images/athlete_avatars/'.$personal->avatar)}}" alt="">
            </figure>
          </div>
          <!-- Player Photo / End -->
          ...
          <div class="player-info__item player-info__item--details">
            ...
            <div class="player-info__title player-info__title--desktop">
              <h1 class="player-info__name">
                ...
                <span class="player-info__last-name">{{$personal->ime}} {{$personal->prezime}}</span>
              </h1>
            </div>
  ...
  <div class="site-content">
          ...
          <div class="content col-md-4 overscreen">
            ...
            <!-- Widget: Osnovne info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$personal->dob}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name"><a class="profil-poveznica" href="#">{{$personal->klub}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
      ...
      <!-- Widget: Kontakt info -->
              ...
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$personal->visina}} cm</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                            ...
                            <td class="lineup__name">{{$personal->tezina}} kg</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('images/icons/runer-silhouette-running-fast.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Primarni ekstremitet</td>
                            <td class="lineup__name">{{$personal->ekstremitet}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('images/icons/street-view.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Pozicija</td>
                            <td class="lineup__name">{{$personal->pozicija}}</td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('images/icons/agent.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Agent</td>
                            <td class="lineup__name"><a class="profil-poveznica" href="www.svezasport.ba">{{$personal->agent}}</a></td>
                          </tr>
              <tr>
              <td class="lineup__info">
                              <img class="flow-icons-012" src="{{asset('images/icons/money.svg')}}" alt="">
                            </td>
                            <td class="lineup__num">Vrijednost <a target="blank" href="http://www.transfermarkt.de">(TM)</a></td>
                            <td class="lineup__name"><a class="profil-poveznica">{{$personal->vrijednost}}</a></td>
                          </tr>
      ...
      <!-- Widget: Marketing sidebar -->
        <div class="row">
              <div class="col-md-12">
                <img src="images/reklama-sidebar.png" class="reklama-klubovi-sidebar"/>
              </div>
            </div>
      ...
      <div class="col-md-6">
              ...
              <td class="lineup__info gadget-no-border">
                            ...
                            <td class="lineup__name gadget-no-border"><img class="zastava-drzave" src="images/icons/bosnia-and-herzegovina.svg" alt=""> {{$personal->drzava}}</td>
                          </tr>
              <tr>
              <td class="lineup__info gadget-no-border">
      ...
      <!-- Widget: Game Result -->
                ...
                <div class="widget-game-result__section">
                  ...
                  <div class="df-timeline-wrapper">
                    <div class="df-timeline">
                      ...
                      @foreach($klupska_historija as $kh)

                      <div class="df-timeline__event">
                        <div class="df-timeline__team-1">
                          <div class="df-timeline__event-info">
                            <div class="df-timeline__event-name">{{$kh->klub}}</div>
                            <div class="df-timeline__event-desc">{{$kh->sezona}}</div>
                          </div>
                        </div>
                        <div class="df-timeline__time"><img src="{{asset('images/SZS-club-logo.png')}}" width="70" height="70" alt="" class="df-timeline__event-icon"></img></div>
                      </div>
            ...
            <div class="df-timeline__event">
                        <div class="df-timeline__team-2">
                          <div class="df-timeline__event-info">
                            <div class="df-timeline__event-name">FK Sve Za Sport</div>
                            <div class="df-timeline__event-desc">2014-2016</div>
                          </div>
                        </div>
                        <div class="df-timeline__time"><img src="{{asset('images/SZS-club-logo.png')}}" width="70" height="70" alt="" class="df-timeline__event-icon"></img></div>
                      </div>
        ...
        <div class="widget-game-result__section">
                  <header class="widget-game-result__subheader card__subheader-alt card__subheader card__subheader--sm card__subheader--nomargins">
                    <h5 class="widget-game-result__subtitle">Aktuelni klub: <a href="#">{{$personal->klub}}</a></h5>
                  </header>
         </div>
      ...
      <!-- Tab: Vitrina -->
        ...
        <div class="row">
          @foreach($sportista_trofej as $st)
          ...
          <div class="col-md-3">
                      <div class="awards__item">
                        ...
                        <div class="awards__desc">
                          <h5 class="awards__name">{{$st->naziv_takmicenja}}</h5>
                          <div class="awards__date">{{$st->sezona}}</div>
                        </div>
                      </div>
            </div>
          ...
          <div class="col-md-3">
                      <div class="awards__item">
                        <figure class="awards__figure awards__figure--space">
                          <img src="{{asset('images/trophies/medal-gold.png')}}" alt="">
                        </figure>
                        <div class="awards__desc">
            ...
            <div class="col-md-3">
                      <div class="awards__item">
                        <figure class="awards__figure awards__figure--space">
                          <img src="{{asset('images/trophies/medal-bronze.png')}}" alt="">
                        </figure>
                        <div class="awards__desc">
                          <h5 class="awards__name">Premier Liga BiH</h5>
                          <div class="awards__date">2017/2018</div>
            ...
            <div class="col-md-3">
                      <div class="awards__item">
                        <figure class="awards__figure awards__figure--space">
                          <img src="{{asset('images/trophies/medal-silver.png')}}" alt="">
                        </figure>
                        <div class="awards__desc">
                          <h5 class="awards__name">Premier Liga BiH</h5>
                          <div class="awards__date">2017/2018</div>
      ...
      <!-- Tab: Galerija -->
        ...
        <div class="row">
          @foreach($sportista_galerija as $sg)

          <div class="album__item col-xs-6 col-sm-4">
            <div class="album__item-holder">
              <a href="{{asset('images/galerija_sportista/'.$sg->url)}}" class="album__item-link mp_gallery">
              <figure class="album__thumb">
                <img src="{{asset('images/galerija_sportista/'.$sg->url)}}" alt="">
              </figure>
