      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('images/icons/soccer-ball-variant.svg')}}"></img></h1>
       ...
       <!-- Single Product Tabbed Content -->
        <div class="product-tabs card card--xlg">
          ...
          <ul class="nav nav-tabs nav-justified nav-product-tabs" role="tablist">
           ...
           <form id="createNewFootballer" role="form" action="{{ url('/athlete/footballer/create') }}" method="POST" enctype="multipart/form-data" >
				{!! csrf_field() !!}	
          <!-- Tab panes -->
