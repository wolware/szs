      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/judo.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">DŽUDISTA</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="tab-content card__content">
			...
			<div class="row form-objavi-klub-01">
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
						<label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Rang</label>
						<select class="form-control" id="ski-disciplina" name="rang">
							<option value="" selected>Izaberite rang</option>
              <?php 
                for($i=9; $i>0; $i--){
                  echo '<option value="'.$i.' Kju">'.$i.' Kju</option>';
                }
                for($i=2; $i<11; $i++){
                  echo '<option value="'.$i.' Dan">'.$i.' Dan</option>';
                }
              ?>
						</select>
					</div>
