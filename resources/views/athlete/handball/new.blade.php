      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/handball.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Rukometaš</li>
            </ol>
          </div>
        </div>
      </div>
       ...
       <!-- Single Product Tabbed Content -->
        <div class="product-tabs card card--xlg">
          ...
          <ul class="nav nav-tabs nav-justified nav-product-tabs" role="tablist">
           ...
           <form id="createNewFootballer" role="form" action="{{ url('/athlete/handball/create') }}" method="POST" enctype="multipart/form-data" >
				{!! csrf_field() !!}	
          <!-- Tab panes -->
				 ...
				 <div class="col-md-6">
				  ...
				  <div class="form-group col-md-12">
                    <label for="karakter-kluba"><img class="flow-icons-013" src="{{asset('images/icons/edit.svg')}}"></img> Karakter sportiste</label>
						<select class="form-control" id="asasasa" name="karakter" required>
