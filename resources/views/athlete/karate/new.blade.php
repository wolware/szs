      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/karate-high-kick.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Karatista</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    ================================================== -->
      ...
      <div class="container">
       ...
       <!-- Single Product Tabbed Content -->
          ...
          <div class="tab-content card__content">
			...
			<div class="row form-objavi-klub-01">
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Kategorija</label>
            <select class="form-control" id="ski-disciplina" name="kategorija">
              <option value="" selected>Izaberite kategoriju</option>
        ...
        <div class="form-group col-md-4">
            <label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/rang-pojas.svg')}}"></img> Pojas</label>
            <select class="form-control" id="ski-disciplina" name="pojas">
              <option value="" selected>Izaberite pojas</option>
              ...
              <option value="2 Kju Smeđi">2 Kju Smeđi</option>
              <option value="1 Kju Crni">1 Kju Crni</option>
            </select>
          </div>
