      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/swimming.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">PLIVAČ</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="tab-content card__content">
			...
			<div class="row form-objavi-klub-01">
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
						<label for="ski-disciplina"><img class="flow-icons-013" src="{{asset('assets/images/icons/glasses.svg')}}"></img> Stil</label>
						<select class="form-control" id="ski-disciplina" name="stil">
							<option value="" selected>Izaberite plivački stil</option>
              <option value="Slobodni stil">Slobodni stil</option>
              <option value="Prsni stil">Prsni stil</option>
              <option value="Leđni stil">Leđni stil</option>
              <option value="Delfin/Leptir stil">Delfin/Leptir stil</option>
              <option value="Mjesovito">Mjesovito</option>
						</select>
					</div>
				
					
          <div class="form-group col-md-4">
            <label for="agent"><img class="flow-icons-013" src="{{asset('assets/images/icons/agent.sv')}}g"></img> Dionica stila</label>
            <input type="text" name="dionica" id="agent" class="form-control" placeholder="Unesite dionicu stila u metrima">
          </div>

          <div class="form-group col-md-4">
            <label for="agent"><img class="flow-icons-013" src="{{asset('assets/images/icons/agent.sv')}}g"></img> Najbolji rezultat</label>
            <input type="text" name="najbolji_rez" id="agent" class="form-control" placeholder="Unesite najbolji rezultat u karijeri">
          </div>

          <div class="form-group col-md-4">
            <label for="agent"><img class="flow-icons-013" src="{{asset('assets/images/icons/agent.sv')}}g"></img> Trener</label>
            <input type="text" name="trener" id="agent" class="form-control" placeholder="Ime i prezime trenera">
          </div>
          <div class="form-group col-md-4">
