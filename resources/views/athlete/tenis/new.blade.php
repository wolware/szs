      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('assets/images/icons/tennis-ball.svg')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Teniser</li>
            </ol>
          </div>
        </div>
      </div>
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
						...
						<select class="form-control" id="ski-disciplina" name="ekstremitet">
							<option value="" selected>Izaberite primarni ekstremitet</option>
              <option value="Desna ruka">Desna ruka</option>
              <option value="Lijeva ruka">Lijeva ruka</option>
						</select>
					</div>
				
					
          <div class="form-group col-md-4">
            <label for="agent"><img class="flow-icons-013" src="{{asset('assets/images/icons/agent.sv')}}g"></img> Pozicija ATP</label>
            <input type="text" name="pozicija" id="agent" class="form-control" placeholder="Unesite poziciju na ATP listi">
          </div>

          <div class="form-group col-md-4">
            <label for="agent"><img class="flow-icons-013" src="{{asset('assets/images/icons/agent.sv')}}g"></img> Najbolja pozicija ATP</label>
            <input type="text" name="najbolja_poz" id="agent" class="form-control" placeholder="Unesite najbolju poziciju na ATP listi">
          </div>
