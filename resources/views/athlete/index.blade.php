            ...
            <div class="container">
                <form role="form" method="GET" class="post-filter__form clearfix forma-filteri">
                    <div class="post-filter__select">
                        <label class="post-filter__label">Kategorija sportiste</label>
                    ...
                    <div class="post-grid__item col-md-3">
                        <div class="posts__item posts__item--card posts__item--category-1 card kartica-igraca-klub">
                            <figure class="posts__thumb club-thumb-backgr">
                                <a href="{{url('/')}}"><img class="logo-club-tab-index" src="{{ asset('images/SZS-club-logo.png')}}" alt=""></a>
                            </figure>
                            <div class="posts__inner card__content">
                                <h6 class="posts__title ime-sportiste-klub-lista"><a href="{{url('')}}">{{''}}</a></h6>
                                <div class="posts__excerpt">{{''}}</div>
                            </div>
                            <footer class="posts__footer card__footer">
                                <a href="{{url('')}}" class="btn btn-warning btn-profil-igraca"><i class="fa fa-eye"></i> Pregled profila kluba</a>
                            </footer>
                        </div>
                    </div>
