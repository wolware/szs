      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-icon-objavi-title"><img src="{{asset('images/icons/aikido.png')}}"></img></h1>
            <h1 class="page-heading__title">Objavi Sportistu</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Aikido</li>
            </ol>
          </div>
        </div>
      </div>
       ...
       <!-- Single Product Tabbed Content -->
        <div class="product-tabs card card--xlg">
          ...
          <ul class="nav nav-tabs nav-justified nav-product-tabs" role="tablist">
           ...
           <form id="createNewFootballer" role="form" action="{{ url('/athlete/aikido/create') }}" method="POST" enctype="multipart/form-data" >
				{!! csrf_field() !!}	
          <!-- Tab panes -->
          <div class="tab-content card__content">
			...
			<div class="row">		
				...
				<div class="row form-segment">
				  ...
				  <div class="form-group col-md-4" id="opSrb">
			...
			<div class="row form-objavi-klub-01">
			 ...
			 <div class="row">
					...
					<div class="form-group col-md-4">
						<label for="pozicija"><img class="flow-icons-013" src="{{asset('images/icons/street-view.svg')}}"></img> Kju rang</label>
						<input type="text" name="rang" id="pozicija" class="form-control" placeholder="Primarna pozicija">
					</div>
