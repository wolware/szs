      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            <h1 class="page-heading__title"><i class="fa fa-bookmark fa-2x"></i></h1>
            <h1 class="page-heading__title">Bitno</h1>
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Spremljene poruke</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <nav class="content-filter">
          <div class="container">
            ...
            <ul class="content-filter__list">
              <li class="content-filter__item "><a href="{{url('messages/inbox')}}" class="content-filter__link"><i class="fa fa-download"></i><small>Primljene</small>Poruke</a></li>
              <li class="content-filter__item "><a href="{{url('messages/outbox')}}" class="content-filter__link"><i class="fa fa-upload"></i><small>Poslane</small>Poruke</a></li>
              <li class="content-filter__item content-filter__item--active"><a href="{{url('messages/important')}}" class="content-filter__link"><i class="fa fa-bookmark"></i><small>Bitne</small>Poruke</a></li>
            </ul>
          </div>
        </nav>
