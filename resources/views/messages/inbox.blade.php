        ...
        <div class="row">
          <div class="col-md-10 col-md-offset-1">
            ...
            <ol class="page-heading__breadcrumb breadcrumb">
              <li class="registracija-podnaslov">Primljene poruke</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <nav class="content-filter">
          <div class="container">
            ...
            <ul class="content-filter__list">
              <li class="content-filter__item content-filter__item--active"><a href="inbox.php" class="content-filter__link"><i class="fa fa-download"></i><small>Primljene</small>Poruke</a></li>
              <li class="content-filter__item "><a href="outbox.php" class="content-filter__link"><i class="fa fa-upload"></i><small>Poslane</small>Poruke</a></li>
                    ...
                    <div class="comments__inner">
                      <header class="comment__header">
                        ...
                        <div class="comment__reply">
                          <a href="#" class="comment__reply-link btn btn-link btn-messages"><i class="fa fa-reply"></i></a>
