...
<meta property="og:image:url" content="{{'http://'.Request::getHost().'/images/staff_avatars/'.$data->avatar}}" />
<meta property="og:image" content="{{'http://'.Request::getHost().'/images/staff_avatars/'.$data->avatar}}" />
