...
class BasketballController extends Controller
{
    ...
    {
        $sportista = 'basketball';
        $personal = DB::table('basketball')->where('id', $id)->first();
        ...
        return view('athlete.basketball.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
