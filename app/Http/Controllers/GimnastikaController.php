...
class GimnastikaController extends Controller
{
    /**
    ...
    {
        return view('athlete.gimnastika.new');
    }
    ...
    public function new(Request $data){
        ...
        if($validator->fails()){
            return redirect('athlete/gimnastika/new')
            ...
            if($data->hasFile('galerija')){
             ...
             return redirect('athlete/gimnastika/'.$id);
        }
    }
    /**
    ...
    {
        $sportista = 'gimnastika';
        $personal = DB::table('gimnastika')->where('id', $id)->first();
        ...
        return view('athlete.gimnastika.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
