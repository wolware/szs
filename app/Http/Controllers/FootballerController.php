...
class FootballerController extends Controller
{
    ...
    {
        $sportista = 'footballer';
        $personal = DB::table('fudbaler')->where('id', $id)->first();
        ...
        return view('athlete.footballer.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
