...
class HandballController extends Controller
{
    ...
    {
        $sportista = 'handball';
        $personal = DB::table('handball')->where('id', $id)->first();
        ...
        return view('athlete.handball.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
