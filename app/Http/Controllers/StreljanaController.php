...
class StreljanaController extends Controller
{
    /**
    ...
    {
        return view('objects.streljana.new');
    }
    public function streljana_show($id){
        $streljana = DB::table('streljana')->where('id', $id)->first();
        return view('objects.streljana.profile', ['streljana' => $streljana]);
    }
    ...
    public function new(Request $data){
        ...
        if($validator->fails()){
            return redirect('objects/streljana/new')
            ...
            $id = DB::table('streljana')->insertGetId([
                ...
                'broj_strelista' => $data['broj_strelista'],
                ...
                'najam_opreme' => $data['najam_opreme'],
                'vlastita_oprema' => $data['vlastita_oprema'],
                'servis_opreme' => $data['servis_opreme'],
                'ormaric' => $data['ormaric'],
                'mokri_cvor' => $data['mokri_cvor'],
                'skola' => $data['skola'],
                'klimatizacija' => $data['klimatizacija'],
                'zastitna_oprema' => $data['zastitna_oprema'],
            ...
            if($data->hasFile('galerija')){
             ...
             return redirect('objects/streljana/'.$id);
        }
    }
