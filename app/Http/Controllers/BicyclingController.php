...
class BicyclingController extends Controller
{
    /**
    ...
    {
        return view('athlete.bicycling.new');
    }
    ...
    public function new(Request $data){
        ...
        if($validator->fails()){
            return redirect('athlete/bicycling/new')
            ...
            if($data->hasFile('galerija')){
             ...
             return redirect('athlete/bicycling/'.$id);
        }
    }
    /**
    ...
    {
        $sportista = 'bicycling';
        $personal = DB::table('bicycling')->where('id', $id)->first();
        ...
        return view('athlete.bicycling.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
