...
class SkiingController extends Controller
{
    /**
    ...
    {
        $sportista = 'skiing';
        $personal = DB::table('skiing')->where('id', $id)->first();
        ...
        return view('athlete.skiing.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
