...
class PlivanjeController extends Controller
{
    /**
    ...
    {
        return view('athlete.plivanje.new');
    }
    ...
    public function new(Request $data){
        ...
        if($validator->fails()){
            return redirect('athlete/plivanje/new')
            ...
            $id = DB::table('bicycling')->insertGetId([
                ...
                'stil' => $data['grana'],
                'trener' => $data['trener'],
                'dionica' => $data['dionica'],
                'najbolji_rez' => $data['najbolji_rez'],
                'agent' => $data['agent'],
             ]);
            ...
            if($data->hasFile('galerija')){
             ...
             return redirect('athlete/plivanje/'.$id);
        }
    }
    /**
    ...
    {
        $sportista = 'plivanje';
        $personal = DB::table('plivanje')->where('id', $id)->first();
        ...
        return view('athlete.plivanje.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
