...
class KarateController extends Controller
{
    ...
    {
        return view('athlete.karate.new');
    }
    ...
    public function new(Request $data){
        ...
        if($validator->fails()){
            return redirect('athlete/karate/new')
            ...
            if($data->hasFile('galerija')){
             ...
             return redirect('athlete/karate/'.$id);
        }
    }
    /**
    ...
    {
        $sportista = 'karate';
        $personal = DB::table('karate')->where('id', $id)->first();
        ...
        return view('athlete.karate.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
