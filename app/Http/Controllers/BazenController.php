...
class BazenController extends Controller
{
    ...
    public function new(Request $data){
        ...
        if($validator->fails()){
            return redirect('objects/bazen/new')
            ...
            $id = DB::table('bazen')->insertGetId([
                ...
                'broj_bazena' => $data['broj_bazena'],
                'vodeni_efekti' => $data['vodeni_efekti'],
                'vodena_povrsina' => $data['vodena_povrsina'],
                ...
                'detektor' => $data['detektor'],
                'detektor' => $data['optimalna_temperatura'],
            ...
            if($data->hasFile('galerija')){
             ...
             return redirect('objects/bazen/'.$id);
        }
    }
