...
class BadmintonController extends Controller
{
    ...
    {
        return view('athlete.badminton.new');
    }
    ...
    public function new(Request $data){
        ...
        if($validator->fails()){
            return redirect('athlete/badminton/new')
            ...
            $id = DB::table('badminton')->insertGetId([
                'avatar' => $newLogoName,
                'ime' => $data['ime'],
            ...
            if($data->hasFile('galerija')){
             ...
             return redirect('athlete/badminton/'.$id);
        }
    }
    /**
    ...
    {
        $sportista = 'badminton';
        $personal = DB::table('badminton')->where('id', $id)->first();
        ...
        return view('athlete.badminton.profile', ['personal' => $personal, 'biografija' => $biografija, 'klupska_historija' => $klupska_historija, 'sportista_trofej' => $sportista_trofej, 'sportista_galerija' => $sportista_galerija]);
    }
